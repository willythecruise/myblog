...
def post_list(request):
    ...
    return render(request, 'blog/post/list.html',{'page':getpage,
                            'posts':posts})
...
def post_detail(request, year, month, day, post):
     ...
     'blog/post/detail.html',{'post': post,'comments':comments,'new_comment':new_comment,
